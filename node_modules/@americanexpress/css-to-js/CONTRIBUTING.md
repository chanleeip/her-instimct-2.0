...
1. Fork the repository `css-to-js` to your GitHub account.
2. Afterwards run the following commands in your terminal

    ```bash
    $ git clone https://github.com/<your-github-username>/css-to-js
    $ cd css-to-js
    ```
...
- Version of css-to-js: [e.g. 1.0.0]
